...
export default function ProfilePage({ onNavigate, user, appointments, onLogout }) {
  ...
  return (
    <div style={s.page}>
      ...
      <main style={s.main} className="profile-main">
        <div style={s.container} className="profile-container">
          
          <div style={s.sideCard} className="profile-side-card">
          ...
          <div style={s.contentArea} className="profile-content-area">
            
            <div style={s.statsRow} className="profile-stats-row">
              <div style={s.statBox} className="profile-stat-box">
            ...
            <div style={s.infoCard} className="profile-info-card">
            ...
            <div style={{...s.infoCard, background: "#faf3e8", border: "1px solid #ecdcc2"}} className="profile-info-card">
